...
foreach(_expectedTarget gRPC::address_sorting gRPC::gpr gRPC::grpc gRPC::grpc_unsecure gRPC::grpc++ gRPC::grpc++_alts gRPC::grpc++_error_details gRPC::grpc++_reflection gRPC::grpc++_unsecure gRPC::grpc_plugin_support gRPC::grpcpp_channelz gRPC::upb)
...
#message(STATUS "+++++++++++gRPC::gpr 1 ${_IMPORT_PREFIX}")
# Use original install prefix when loaded through a
# cross-prefix symbolic link such as /lib -> /usr/lib.
get_filename_component(_realCurr "${_IMPORT_PREFIX}" REALPATH)
get_filename_component(_realOrig "/usr/lib/cmake/grpc" REALPATH)
if(_realCurr STREQUAL _realOrig)
  set(_IMPORT_PREFIX "/usr/lib/cmake/grpc")
endif()
unset(_realOrig)
unset(_realCurr)
...
#message(STATUS "+++++++++++gRPC::gpr 8 ${_IMPORT_PREFIX}")
...
set_target_properties(gRPC::gpr PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "dl;rt;m;pthread;absl::optional;absl::time;absl::synchronization;absl::strings;absl::str_format;absl::status;absl::memory;absl::base"
)
...
set_target_properties(gRPC::grpc PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "OpenSSL::SSL;OpenSSL::Crypto;ZLIB::ZLIB;c-ares::cares;gRPC::address_sorting;re2::re2;gRPC::upb;dl;rt;m;pthread;gRPC::gpr;gRPC::address_sorting;gRPC::upb;absl::optional;absl::strings;absl::statusor;absl::status;absl::bind_front;absl::inlined_vector;absl::flat_hash_set;absl::flat_hash_map"
)
...
set_target_properties(gRPC::grpc_unsecure PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "ZLIB::ZLIB;c-ares::cares;gRPC::address_sorting;re2::re2;gRPC::upb;dl;rt;m;pthread;gRPC::gpr;gRPC::address_sorting;gRPC::upb;absl::optional;absl::strings;absl::statusor;absl::status;absl::inlined_vector;absl::flat_hash_map"
)
...
foreach(target ${_IMPORT_CHECK_TARGETS} )
  foreach(file ${_IMPORT_CHECK_FILES_FOR_${target}} )
	  #message(STATUS "------------------------------------gRPC imported file: ${file}")
    if(NOT EXISTS "${file}" )
